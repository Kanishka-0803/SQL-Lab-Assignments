CREATE DATABASE HospitalAnalysis_db;
...
SELECT PatientName,length(PatientName)
FROM patientrecords;
...
-- Q15 Length of Stay
SELECT patientname,datediff(DischargeDate,AdmissionDate)
FROM patientrecords;
-- Q16 Admission Year
SELECT PatientName,year(AdmissionDate)
FROM patientrecords;
-- Advanced Queries
